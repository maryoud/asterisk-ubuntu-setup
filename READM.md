...
- Avant de modifier les fichiers (sip.conf, extensions.conf et voicemail.conf, on doit créer des backup "ex:  sip.conf.backup")

- il suffit de modifier les numéros et les addresses ip existant selon votre préferance et le réseau

- Leur emplacement ( /etc/asterisk )
...
# Teste
- après attribution des numéros, tester les deux clients
